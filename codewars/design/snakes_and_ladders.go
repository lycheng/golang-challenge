...
func (sl *SnakesLadders) NewGame() {
	...
	sl.ladders = map[int]int{2: 38, 7: 14, 8: 31, 15: 26, 21: 42, 28: 84, 36: 44, 51: 67, 71: 91, 78: 98, 87: 94}
	sl.snakes = map[int]int{99: 80, 95: 75, 92: 88, 89: 68, 74: 53, 64: 60, 62: 19, 49: 11, 46: 25, 16: 6}
}
...
func (sl *SnakesLadders) Play(die1, die2 int) string {
	...
	if n := sl.ladders[next]; n > 0 {
		next = n
	}

	if n := sl.snakes[next]; n > 0 {
		next = n
	}
